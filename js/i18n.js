...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'hero.description': 'Technical Project Manager &amp; VR Software Engineer with <strong class="accent">7 years of experience</strong> crafting 3D solutions, VR simulations, AI-powered interfaces, and interactive web experiences that captivate clients and deliver tangible results.',
    ...
    'proj1.desc':  'A <strong>multiplayer VR simulation</strong> where <strong>AI-driven enemies</strong> adapt to each trainee\'s performance. <strong>Biometric sensors</strong> (heart rate, blood oxygenation) feed into the game engine to dynamically adjust mission difficulty. A training environment that responds to stress, focus, and fatigue in real time.',
    'proj2.tag':   'AI / NLP',
    'proj2.title': 'Multilingual AI Customer Avatar',
    'proj2.desc':  'A <strong>real-time voice AI avatar</strong> that understands and responds in <strong>17 languages</strong> with under <strong>2.5-second latency</strong>. Powered by <strong>Unity</strong> for 3D rendering, <strong>ElevenLabs</strong> for speech synthesis, and <strong>Google Gemini</strong> for intent recognition. A lifelike conversational agent without buttons or menus.',
    'proj3.tag':   'Web / Three.js',
    'proj3.title': '3D Interactive Brand Experience',
    'proj3.desc':  'An <strong>interactive 3D website</strong> built with <strong>Three.js</strong> that turns brand exploration into a playful adventure for children. <strong>GPU-accelerated visuals</strong>, whimsical animations, and smooth camera controls invite young users to discover products through curiosity and play. Brand engagement made fun, not transactional.',
    'proj4.tag':   'VR Education',
    'proj4.title': 'VR Education Platform — Immersive Learning for Kids',
    'proj4.desc':  'A <strong>multi-platform VR education ecosystem</strong> spanning <strong>VR headsets</strong>, <strong>web browsers</strong>, and a <strong>real-time teacher dashboard</strong>. Students explore curriculum-aligned 3D lessons in immersive virtual classrooms. Educators track progress, assign content, and customize learning paths. Architected for scale with a unified backend.',
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Industrial 3D Visualization Platform',
    'proj5.desc':  'A <strong>digital twin platform</strong> that ingests <strong>BIM data</strong> via API and dynamically constructs interactive 3D visualizations in real time. <strong>Custom HLSL shaders</strong> boost rendering performance by <strong>12%</strong>, while <strong>async C# data pipelines</strong> reduce load times by <strong>70%</strong>. Features interactive exploded views, assembly animations, and guided maintenance walkthroughs.',
    'proj6.tag':   'Branding',
    'proj6.title': '3D Motion Branding Campaign',
    'proj6.desc':  'A <strong>dynamic motion branding</strong> experience combining <strong>procedural world generation</strong>, <strong>real-time physics</strong>, and <strong>cinematic 3D animation</strong>. Captivates audiences with fluid visual storytelling from product reveals to immersive environments that stop the scroll and communicate brand value in seconds.',
  ...
  fr: {
    ...
    'hero.description': 'Chef de Projet Technique &amp; Ingénieur VR avec <strong class="accent">7 ans d\'expérience</strong> à créer des solutions 3D, simulations VR, interfaces IA et expériences web interactives qui captivent les clients et offrent des résultats tangibles.',
    ...
    'proj1.desc':  'Une <strong>simulation VR multijoueur</strong> où des <strong>ennemis pilotés par IA</strong> s\'adaptent aux performances de chaque stagiaire. Des <strong>capteurs biométriques</strong> (fréquence cardiaque, oxygénation) ajustent dynamiquement la difficulté des missions. Un environnement qui réagit au stress, à la concentration et à la fatigue en temps réel.',
    'proj2.tag':   'IA / NLP',
    'proj2.title': 'Avatar IA Client Multilingue',
    'proj2.desc':  'Un <strong>avatar vocal IA temps réel</strong> qui comprend et répond en <strong>17 langues</strong> en moins de <strong>2,5 secondes</strong>. Propulsé par <strong>Unity</strong> pour le rendu 3D, <strong>ElevenLabs</strong> pour la synthèse vocale et <strong>Google Gemini</strong> pour la reconnaissance d\'intention. Sans boutons ni menus.',
    'proj3.tag':   'Web / Three.js',
    'proj3.title': 'Expérience de Marque 3D Interactive',
    'proj3.desc':  'Un <strong>site web 3D interactif</strong> conçu avec <strong>Three.js</strong> qui transforme l\'exploration de marque en une aventure ludique pour les enfants. <strong>Visuels GPU-accélérés</strong> et animations whimsical invitent les jeunes utilisateurs à découvrir les produits par la curiosité et le jeu.',
    'proj4.tag':   'Éducation VR',
    'proj4.title': "Plateforme Éducation VR — Apprentissage Immersif pour Enfants",
    'proj4.desc':  'Un <strong>écosystème éducatif VR multi-plateforme</strong> couvrant les <strong>casques VR</strong>, les <strong>navigateurs web</strong> et un <strong>tableau de bord enseignant</strong> en temps réel. Les élèves explorent des leçons 3D alignées sur les programmes dans des classes virtuelles immersives. Les éducateurs suivent les progrès et personnalisent les parcours d\'apprentissage.',
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Plateforme de Visualisation 3D Industrielle',
    'proj5.desc':  'Une <strong>platforme de jumeau numérique</strong> qui ingère des <strong>données BIM</strong> via API et construit dynamiquement des visualisations 3D interactives en temps réel. Des <strong>shaders HLSL</strong> sur mesure boostent les performances de rendu de <strong>12%</strong>, tandis que les <strong>pipelines de données asynchrones C#</strong> réduisent les temps de chargement de <strong>70%</strong>.',
    'proj6.tag':   'Branding',
    'proj6.title': 'Campagne de Branding Motion 3D',
    'proj6.desc':  'Une <strong>expérience de branding motion</strong> combinant <strong>génération procédurale de mondes</strong>, <strong>physique temps réel</strong> et <strong>animation 3D cinématique</strong>. Conçue pour captiver les audiences avec un storytelling visuel fluide qui arrête le défilement.',
  ...
  ar: {
    ...
    'hero.description': 'مدير مشاريع تقنية ومهندس VR مع <strong class="accent">7 سنوات</strong> من الخبرة في صياغة حلول ثلاثية الأبعاد ومحاكاة VR وواجهات ذكاء اصطناعي وتجارب ويب تفاعلية تأسر العملاء وتحقق نتائج ملموسة.',
    ...
    'proj1.desc':  '<strong>محاكاة VR متعددة اللاعبين</strong> حيث يتكيف <strong>الأعداء المدعومون بالذكاء الاصطناعي</strong> مع أداء كل متدرب. <strong>أجهزة القياس الحيوية</strong> (معدل ضربات القلب، الأوكسجين) تعدل صعوبة المهام في الوقت الفعلي.',
    'proj2.tag':   'ذكاء اصطناعي / معالجة لغوية',
    'proj2.title': 'أفاتار عميل ذكاء اصطناعي متعدد اللغات',
    'proj2.desc':  '<strong>أفاتار صوتي ذكي</strong> يفهم ويستجيب بـ <strong>17 لغة</strong> في أقل من <strong>2.5 ثانية</strong>. يعمل بتقنية <strong>Unity</strong> للعرض ثلاثي الأبعاد و <strong>ElevenLabs</strong> للتركيب الصوتي و <strong>Google Gemini</strong> لفهم القصد. بدون أزرار أو قوائم.',
    'proj3.tag':   'ويب / Three.js',
    'proj3.title': 'تجربة العلامة التجارية ثلاثية الأبعاد التفاعلية',
    'proj3.desc':  '<strong>موقع ويب ثلاثي الأبعاد تفاعلي</strong> مبني بتقنية <strong>Three.js</strong> يحوّل استكشاف العلامة التجارية إلى مغامرة ممتعة للأطفال. <strong>رسومات متسارعة بوحدة المعالجة</strong> ورسوم متحركة مرحة تدعو الصغار لاكتشاف المنتجات من خلال الفضول واللعب.',
    'proj4.tag':   'تعليم VR',
    'proj4.title': 'منصة تعليم VR — تعلم غامر للأطفال',
    'proj4.desc':  '<strong>نظام تعليمي VR متعدد المنصات</strong> يشمل <strong>سماعات VR</strong> و <strong>متصفحات الويب</strong> و <strong>لوحة تحكم المعلم</strong> في الوقت الفعلي. يستكشف الطلاب دروساً ثلاثية الأبعاد في فصول افتراضية غامرة. يتتبع المعلمون التقدم ويخصصون مسارات التعلم.',
    'proj5.tag':   'ثلاثي الأبعاد / Unity',
    'proj5.title': 'منصة التصور الصناعي ثلاثي الأبعاد',
    'proj5.desc':  '<strong>منصة توأم رقمي</strong> تستورد <strong>بيانات BIM</strong> عبر API وتبني تصورات ثلاثية الأبعاد تفاعلية في الوقت الفعلي. <strong>التظليلات المخصصة</strong> تزيد أداء العرض بنسبة <strong>12%</strong> بينما <strong>خطوط البيانات غير المتزامنة C#</strong> تقلل أوقات التحميل بنسبة <strong>70%</strong>.',
    'proj6.tag':   'هوية بصرية',
    'proj6.title': 'حملة العلامة التجارية بالحركة ثلاثية الأبعاد',
    'proj6.desc':  '<strong>تجربة حركة ديناميكية</strong> تجمع بين <strong>التوليد الإجرائي للعوالم</strong> و <strong>الفيزياء في الوقت الفعلي</strong> و <strong>الرسوم المتحركة ثلاثية الأبعاد السينمائية</strong>. مصممة لجذب الجماهير بسرد بصري سلس يوقف التصفح.',
  ...
  es: {
    ...
    'hero.description': 'Gerente de Proyectos Técnicos &amp; Ingeniero VR con <strong class="accent">7 años de experiencia</strong> creando soluciones 3D, simulaciones VR, interfaces con IA y experiencias web interactivas que cautivan clientes y generan resultados tangibles.',
    ...
    'proj1.desc':  'Una <strong>simulación VR multijugador</strong> donde <strong>enemigos impulsados por IA</strong> se adaptan al rendimiento de cada alumno. <strong>Sensores biométricos</strong> (frecuencia cardíaca, oxigenación) ajustan dinámicamente la dificultad de las misiones. Un entorno que responde al estrés, enfoque y fatiga en tiempo real.',
    'proj2.tag':   'IA / NLP',
    'proj2.title': 'Avatar de Cliente IA Multilingüe',
    'proj2.desc':  'Un <strong>avatar de voz IA</strong> en tiempo real que entiende y responde en <strong>17 idiomas</strong> con menos de <strong>2.5 segundos</strong> de latencia. Impulsado por <strong>Unity</strong> para renderizado 3D, <strong>ElevenLabs</strong> para síntesis de voz y <strong>Google Gemini</strong> para reconocimiento de intención. Sin botones ni menús.',
    'proj3.tag':   'Web / Three.js',
    'proj3.title': 'Experiencia de Marca 3D Interactiva',
    'proj3.desc':  'Un <strong>sitio web 3D interactivo</strong> construido con <strong>Three.js</strong> que convierte la exploración de marca en una aventura lúdica para niños. <strong>Visuales acelerados por GPU</strong> y animaciones caprichosas invitan a los jóvenes usuarios a descubrir productos a través de la curiosidad y el juego.',
    'proj4.tag':   'Educación VR',
    'proj4.title': 'Plataforma Educativa VR — Aprendizaje Inmersivo para Niños',
    'proj4.desc':  'Un <strong>ecosistema educativo VR multiplataforma</strong> que abarca <strong>cascos VR</strong>, <strong>navegadores web</strong> y un <strong>panel de control para maestros</strong> en tiempo real. Los estudiantes exploran lecciones 3D alineadas con el currículo en aulas virtuales inmersivas. Los educadores siguen el progreso y personalizan las rutas de aprendizaje.',
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Plataforma de Visualización 3D Industrial',
    'proj5.desc':  'Una <strong>plataforma gemela digital</strong> que ingiere <strong>datos BIM</strong> a través de API y construye dinámicamente visualizaciones 3D interactivas en tiempo real. <strong>Shaders HLSL</strong> personalizados aumentan el rendimiento de renderizado en un <strong>12%</strong>, mientras que los <strong>pipelines de datos asíncronos en C#</strong> reducen los tiempos de carga en un <strong>70%</strong>.',
    'proj6.tag':   'Branding',
    'proj6.title': 'Campaña de Branding Motion 3D',
    'proj6.desc':  'Una <strong>experiencia de branding motion dinámica</strong> que combina <strong>generación procedimental de mundos</strong>, <strong>física en tiempo real</strong> y <strong>animación 3D cinematográfica</strong>. Diseñada para cautivar audiencias con narrativa visual fluida que detiene el scroll.',
  ...
  zh: {
    ...
    'hero.description': '技术项目经理 &amp; VR软件工程师，拥有<strong class="accent">7年经验</strong>，打造3D解决方案、VR模拟、AI驱动界面和交互式网页体验，吸引客户并带来切实成果。',
    'hero.cta':         '探索我的服务',
    ...
    'proj1.desc':  '<strong>多人VR模拟训练</strong>，<strong>AI驱动</strong>的敌人根据学员表现实时调整战术。<strong>生物传感器</strong>（心率、血氧）数据输入游戏引擎，动态改变任务难度。能实时响应压力、专注度和疲劳的训练环境。',
    'proj2.tag':   'AI / NLP',
    'proj2.title': '多语言AI客户虚拟形象',
    'proj2.desc':  '<strong>实时语音AI虚拟形象</strong>，能理解并回应<strong>17种语言</strong>，延迟低于<strong>2.5秒</strong>。采用<strong>Unity</strong>进行3D渲染、<strong>ElevenLabs</strong>进行自然语音合成、<strong>Google Gemini</strong>进行意图识别。无需按钮或菜单。',
    'proj3.tag':   '网页 / Three.js',
    'proj3.title': '3D交互式品牌体验',
    'proj3.desc':  '<strong>交互式3D网站</strong>基于<strong>Three.js</strong>构建，将品牌探索转化为儿童的趣味冒险。<strong>GPU加速</strong>的视觉效果和奇趣动画，吸引年轻用户通过好奇心和游戏来发现产品。',
    'proj4.tag':   'VR教育',
    'proj4.title': 'VR教育平台——儿童沉浸式学习',
    'proj4.desc':  '<strong>跨平台VR教育生态系统</strong>，涵盖<strong>VR头显</strong>、<strong>网页浏览器</strong>和<strong>实时教师仪表板</strong>。学生在沉浸式虚拟教室中探索符合课程标准的3D课程。教师可追踪进度、分配内容和定制学习路径。',
    'proj5.tag':   '3D / Unity',
    'proj5.title': '工业3D可视化平台',
    'proj5.desc':  '<strong>数字孪生平台</strong>，通过API接收<strong>BIM数据</strong>并动态构建交互式3D可视化。<strong>自定义HLSL着色器</strong>提升渲染性能<strong>12%</strong>，<strong>异步C#数据管道</strong>将加载时间减少<strong>70%</strong>。支持交互式爆炸视图、装配动画和维护指导。',
    'proj6.tag':   '品牌形象',
    'proj6.title': '3D动态品牌推广活动',
    'proj6.desc':  '<strong>动态品牌体验</strong>，融合了<strong>程序化世界生成</strong>、<strong>实时物理</strong>和<strong>电影级3D动画</strong>。通过流畅的视觉叙事吸引观众，让浏览者停驻并迅速传达品牌价值。',
  ...
  ru: {
    ...
    'hero.description': 'Технический руководитель проектов &amp; VR-инженер с <strong class="accent">7-летним опытом</strong> создания 3D-решений, VR-симуляций, интерфейсов на ИИ и интерактивных веб-опытов, которые захватывают клиентов и приносят ощутимые результаты.',
    ...
    'proj1.desc':  '<strong>Многопользовательская VR-симуляция</strong>, где <strong>ИИ-противники</strong> адаптируются к действиям каждого курсанта. <strong>Биометрические датчики</strong> (пульс, насыщение крови кислородом) передают данные в игровой движок, динамически меняя сложность миссий. Среда, реагирующая на стресс, концентрацию и усталость в реальном времени.',
    'proj2.tag':   'ИИ / NLP',
    'proj2.title': 'Многоязычный ИИ-аватар Клиента',
    'proj2.desc':  '<strong>Голосовой ИИ-аватар</strong> реального времени, понимающий и отвечающий на <strong>17 языках</strong> с задержкой менее <strong>2,5 секунд</strong>. Работает на <strong>Unity</strong> для 3D-рендеринга, <strong>ElevenLabs</strong> для синтеза речи и <strong>Google Gemini</strong> для распознавания намерений. Без кнопок и меню.',
    'proj3.tag':   'Веб / Three.js',
    'proj3.title': '3D Интерактивный Брендовый Опыт',
    'proj3.desc':  '<strong>Интерактивный 3D-сайт</strong> на <strong>Three.js</strong>, превращающий исследование бренда в игровое приключение для детей. <strong>Визуальные эффекты с GPU-ускорением</strong> и причудливые анимации приглашают юных пользователей открывать продукты через любопытство и игру.',
    'proj4.tag':   'VR-образование',
    'proj4.title': 'VR Образовательная Платформа — Иммерсивное Обучение для Детей',
    'proj4.desc':  '<strong>Кроссплатформенная VR-экосистема</strong> образования, охватывающая <strong>VR-шлемы</strong>, <strong>веб-браузеры</strong> и <strong>панель управления учителя</strong> в реальном времени. Студенты изучают 3D-уроки в иммерсивных виртуальных классах. Преподаватели отслеживают прогресс, назначают задания и настраивают учебные планы.',
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Платформа Промышленной 3D-Визуализации',
    'proj5.desc':  '<strong>Платформа цифровых двойников</strong>, которая получает <strong>BIM-данные</strong> через API и динамически строит интерактивные 3D-визуализации в реальном времени. <strong>Пользовательские HLSL-шейдеры</strong> повышают производительность рендеринга на <strong>12%</strong>, а <strong>асинхронные C#-конвейеры</strong> сокращают время загрузки на <strong>70%</strong>.',
    'proj6.tag':   'Брендинг',
    'proj6.title': '3D Motion Брендинговая Кампания',
    'proj6.desc':  '<strong>Динамический motion-брендинг</strong>, объединяющий <strong>процедурную генерацию миров</strong>, <strong>физику реального времени</strong> и <strong>кинематографичную 3D-анимацию</strong>. Создан, чтобы захватывать аудиторию плавным визуальным повествованием, останавливающим прокрутку.',
...
(function () {
  ...
  function applyLang(lang) {
    ...
    // Expose project descriptions for lightbox modal (used in main.js)
    window.__i18nLightbox = {
      proj1_desc: t['proj1.desc'] || '',
      proj2_desc: t['proj2.desc'] || '',
      proj3_desc: t['proj3.desc'] || '',
      proj4_desc: t['proj4.desc'] || '',
      proj5_desc: t['proj5.desc'] || '',
      proj6_desc: t['proj6.desc'] || '',
    };
