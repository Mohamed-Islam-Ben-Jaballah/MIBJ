...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'proj1.desc':  'A high-stakes multiplayer VR simulation where AI-driven enemies adapt to each trainee\'s performance. Biometric sensors (heart rate, blood oxygenation) feed into the game engine to dynamically adjust mission difficulty — creating a training environment that responds to stress, focus, and fatigue in real time.',
    'proj2.tag':   'AI / NLP',
    'proj2.title': 'Multilingual AI Customer Avatar',
    'proj2.desc':  'A real-time voice AI avatar that understands and responds in 17 languages with under 2.5-second latency. Powered by Unity for 3D rendering, ElevenLabs for natural speech synthesis, and Google Gemini for intent recognition — creating a lifelike conversational agent that customers can speak to naturally, without buttons or menus.',
    'proj3.tag':   'Web / Three.js',
    'proj3.title': '3D Interactive Brand Experience',
    'proj3.desc':  'An interactive 3D website built with Three.js that turns brand exploration into a playful adventure for children. GPU-accelerated visuals, whimsical animations, and smooth camera controls invite young users to discover products through curiosity and play — making brand engagement fun, not transactional.',
    'proj4.tag':   'VR Education',
    'proj4.title': 'VR Education Platform — Immersive Learning for Kids',
    'proj4.desc':  'A multi-platform VR education ecosystem spanning VR headsets, web browsers, and a real-time teacher dashboard. Students explore curriculum-aligned 3D lessons in immersive virtual classrooms while educators track progress, assign content, and customize learning paths. Architected for scale, serving schools and training institutions with a unified backend.',
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Industrial 3D Visualization Platform',
    'proj5.desc':  'A digital twin platform that ingests BIM data via API and dynamically constructs interactive 3D visualizations in real time. Custom HLSL shaders boost rendering performance by 12%, while async C# data pipelines reduce load times by 70%. Features interactive exploded views, assembly animations, and guided maintenance walkthroughs in a responsive 3D interface.',
    'proj6.tag':   'Branding',
    'proj6.title': '3D Motion Branding Campaign',
    'proj6.desc':  'A dynamic motion branding experience combining procedural world generation, real-time physics, and cinematic 3D animation. Designed to captivate audiences with fluid visual storytelling — from product reveals to immersive environments that stop the scroll and communicate brand value in seconds.',
  ...
  fr: {
    ...
    'proj1.desc':  "Une simulation VR multijoueur où des ennemis pilotés par IA s'adaptent aux performances de chaque stagiaire. Des capteurs biométriques (fréquence cardiaque, oxygénation) ajustent dynamiquement la difficulté des missions — un environnement d'entraînement qui réagit au stress, à la concentration et à la fatigue en temps réel.",
    'proj2.tag':   'IA / NLP',
    'proj2.title': 'Avatar IA Client Multilingue',
    'proj2.desc':  "Un avatar vocal IA temps réel qui comprend et répond en 17 langues en moins de 2,5 secondes. Propulsé par Unity pour le rendu 3D, ElevenLabs pour la synthèse vocale et Google Gemini pour la reconnaissance d'intention — un agent conversationnel lifelike sans boutons ni menus.",
    'proj3.tag':   'Web / Three.js',
    'proj3.title': 'Expérience de Marque 3D Interactive',
    'proj3.desc':  "Un site web 3D interactif conçu avec Three.js qui transforme l'exploration de marque en une aventure ludique pour les enfants. Visuels GPU-accélérés et animations whimsical invitent les jeunes utilisateurs à découvrir les produits par la curiosité et le jeu.",
    'proj4.tag':   'Éducation VR',
    'proj4.title': "Plateforme Éducation VR — Apprentissage Immersif pour Enfants",
    'proj4.desc':  "Un écosystème éducatif VR multi-plateforme couvrant les casques VR, les navigateurs web et un tableau de bord enseignant en temps réel. Les élèves explorent des leçons 3D alignées sur les programmes dans des classes virtuelles immersives tandis que les éducateurs suivent les progrès et personnalisent les parcours d'apprentissage.",
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Plateforme de Visualisation 3D Industrielle',
    'proj5.desc':  "Un platforme de jumeau numérique qui ingère des données BIM via API et construit dynamiquement des visualisations 3D interactives en temps réel. Des shaders HLSL sur mesure boostent les performances de rendu de 12%, tandis que les pipelines de données asynchrones C# réduisent les temps de chargement de 70%.",
    'proj6.tag':   'Branding',
    'proj6.title': 'Campagne de Branding Motion 3D',
    'proj6.desc':  "Une expérience de branding motion dynamique combinant génération procédurale de mondes, physique temps réel et animation 3D cinématique. Conçue pour captiver les audiences avec un storytelling visuel fluide qui arrête le défilement.",
  ...
  ar: {
    ...
    'proj1.desc':  'محاكاة VR متعددة اللاعبين حيث يتكيف الأعداء المدعومون بالذكاء الاصطناعي مع أداء كل متدرب. تستشعر أجهزة القياس الحيوية (معدل ضربات القلب، الأوكسجين) ضغط المتدرب وتركيزه لتعديل صعوبة المهام في الوقت الفعلي.',
    'proj2.tag':   'ذكاء اصطناعي / معالجة لغوية',
    'proj2.title': 'أفاتار عميل ذكاء اصطناعي متعدد اللغات',
    'proj2.desc':  'أفاتار صوتي ذكي يفهم ويستجيب بـ 17 لغة في أقل من 2.5 ثانية. يعمل بتقنية Unity للعرض ثلاثي الأبعاد و ElevenLabs للتركيب الصوتي و Google Gemini لفهم القصد — بدون أزرار أو قوائم.',
    'proj3.tag':   'ويب / Three.js',
    'proj3.title': 'تجربة العلامة التجارية ثلاثية الأبعاد التفاعلية',
    'proj3.desc':  'موقع ويب ثلاثي الأبعاد تفاعلي مبني بتقنية Three.js يحوّل استكشاف العلامة التجارية إلى مغامرة ممتعة للأطفال. رسومات متسارعة بوحدة المعالجة ورسوم متحركة مرحة تدعو الصغار لاكتشاف المنتجات من خلال الفضول واللعب.',
    'proj4.tag':   'تعليم VR',
    'proj4.title': 'منصة تعليم VR — تعلم غامر للأطفال',
    'proj4.desc':  'نظام تعليمي VR متعدد المنصات يشمل سماعات VR ومتصفحات الويب ولوحة تحكم المعلم في الوقت الفعلي. يستكشف الطلاب دروساً ثلاثية الأبعاد متوافقة مع المناهج في فصول افتراضية غامرة بينما يتتبع المعلمون التقدم ويخصصون مسارات التعلم.',
    'proj5.tag':   'ثلاثي الأبعاد / Unity',
    'proj5.title': 'منصة التصور الصناعي ثلاثي الأبعاد',
    'proj5.desc':  'منصة توأم رقمي تستورد بيانات BIM عبر API وتبني تصورات ثلاثية الأبعاد تفاعلية في الوقت الفعلي. تزيد التظليلات المخصصة أداء العرض بنسبة 12% بينما تقلل خطوط البيانات غير المتزامنة C# أوقات التحميل بنسبة 70%.',
    'proj6.tag':   'هوية بصرية',
    'proj6.title': 'حملة العلامة التجارية بالحركة ثلاثية الأبعاد',
    'proj6.desc':  'تجربة حركة ديناميكية تجمع بين التوليد الإجرائي للعوالم والفيزياء في الوقت الفعلي والرسوم المتحركة ثلاثية الأبعاد السينمائية. مصممة لجذب الجماهير بسرد بصري سلس يوقف التصفح.',
  ...
  es: {
    ...
    'proj1.desc':  'Una simulación VR multijugador donde enemigos impulsados por IA se adaptan al rendimiento de cada alumno. Sensores biométricos (frecuencia cardíaca, oxigenación) ajustan dinámicamente la dificultad de las misiones — un entorno que responde al estrés, enfoque y fatiga en tiempo real.',
    'proj2.tag':   'IA / NLP',
    'proj2.title': 'Avatar de Cliente IA Multilingüe',
    'proj2.desc':  'Un avatar de voz IA en tiempo real que entiende y responde en 17 idiomas con menos de 2.5 segundos de latencia. Impulsado por Unity para renderizado 3D, ElevenLabs para síntesis de voz y Google Gemini para reconocimiento de intención — sin botones ni menús.',
    'proj3.tag':   'Web / Three.js',
    'proj3.title': 'Experiencia de Marca 3D Interactiva',
    'proj3.desc':  'Un sitio web 3D interactivo construido con Three.js que convierte la exploración de marca en una aventura lúdica para niños. Visuales acelerados por GPU y animaciones caprichosas invitan a los jóvenes usuarios a descubrir productos a través de la curiosidad y el juego.',
    'proj4.tag':   'Educación VR',
    'proj4.title': 'Plataforma Educativa VR — Aprendizaje Inmersivo para Niños',
    'proj4.desc':  'Un ecosistema educativo VR multiplataforma que abarca cascos VR, navegadores web y un panel de control para maestros en tiempo real. Los estudiantes exploran lecciones 3D alineadas con el currículo en aulas virtuales inmersivas mientras los educadores siguen el progreso y personalizan las rutas de aprendizaje.',
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Plataforma de Visualización 3D Industrial',
    'proj5.desc':  'Una plataforma gemela digital que ingiere datos BIM a través de API y construye dinámicamente visualizaciones 3D interactivas en tiempo real. Shaders HLSL personalizados aumentan el rendimiento de renderizado en un 12%, mientras que los pipelines de datos asíncronos en C# reducen los tiempos de carga en un 70%.',
    'proj6.tag':   'Branding',
    'proj6.title': 'Campaña de Branding Motion 3D',
    'proj6.desc':  'Una experiencia de branding motion dinámica que combina generación procedimental de mundos, física en tiempo real y animación 3D cinematográfica. Diseñada para cautivar audiencias con narrativa visual fluida que detiene el scroll.',
  ...
  zh: {
    ...
    'proj1.desc':  '一款高风险的多人VR模拟训练，AI驱动的敌人会根据每位学员的表现实时调整战术。生物传感器（心率、血氧）数据输入游戏引擎，动态改变任务难度——打造一个能实时响应压力、专注度和疲劳的训练环境。',
    'proj2.tag':   'AI / NLP',
    'proj2.title': '多语言AI客户虚拟形象',
    'proj2.desc':  '一个实时语音AI虚拟形象，能理解并回应17种语言，延迟低于2.5秒。采用Unity进行3D渲染、ElevenLabs进行自然语音合成、Google Gemini进行意图识别——无需按钮或菜单，打造逼真的对话体验。',
    'proj3.tag':   '网页 / Three.js',
    'proj3.title': '3D交互式品牌体验',
    'proj3.desc':  '基于Three.js构建的交互式3D网站，将品牌探索转化为儿童的趣味冒险。GPU加速的视觉效果和奇趣动画，吸引年轻用户通过好奇心和游戏来发现产品。',
    'proj4.tag':   'VR教育',
    'proj4.title': 'VR教育平台——儿童沉浸式学习',
    'proj4.desc':  '一个跨平台VR教育生态系统，涵盖VR头显、网页浏览器和实时教师仪表板。学生在沉浸式虚拟教室中探索符合课程标准的3D课程，教师可追踪进度、分配内容和定制学习路径。',
    'proj5.tag':   '3D / Unity',
    'proj5.title': '工业3D可视化平台',
    'proj5.desc':  '一个数字孪生平台，通过API接收BIM数据并动态构建交互式3D可视化。自定义HLSL着色器提升渲染性能12%，异步C#数据管道将加载时间减少70%。支持交互式爆炸视图、装配动画和维护指导。',
    'proj6.tag':   '品牌形象',
    'proj6.title': '3D动态品牌推广活动',
    'proj6.desc':  '一个动态动态品牌体验，融合了程序化世界生成、实时物理和电影级3D动画。旨在通过流畅的视觉叙事吸引观众，让浏览者停驻并迅速传达品牌价值。',
  ...
  ru: {
    ...
    'proj1.desc':  'Многопользовательская VR-симуляция высокого напряжения, где ИИ-противники адаптируются к действиям каждого курсанта. Биометрические датчики (пульс, насыщение крови кислородом) передают данные в игровой движок, динамически меняя сложность миссий — среда, реагирующая на стресс, концентрацию и усталость в реальном времени.',
    'proj2.tag':   'ИИ / NLP',
    'proj2.title': 'Многоязычный ИИ-аватар Клиента',
    'proj2.desc':  'Голосовой ИИ-аватар реального времени, понимающий и отвечающий на 17 языках с задержкой менее 2,5 секунд. Работает на Unity для 3D-рендеринга, ElevenLabs для синтеза речи и Google Gemini для распознавания намерений — без кнопок и меню.',
    'proj3.tag':   'Веб / Three.js',
    'proj3.title': '3D Интерактивный Брендовый Опыт',
    'proj3.desc':  'Интерактивный 3D-сайт на Three.js, превращающий исследование бренда в игровое приключение для детей. Визуальные эффекты с GPU-ускорением и причудливые анимации приглашают юных пользователей открывать продукты через любопытство и игру.',
    'proj4.tag':   'VR-образование',
    'proj4.title': 'VR Образовательная Платформа — Иммерсивное Обучение для Детей',
    'proj4.desc':  'Кроссплатформенная VR-экосистема образования, охватывающая VR-шлемы, веб-браузеры и панель управления учителя в реальном времени. Студенты изучают 3D-уроки в иммерсивных виртуальных классах, а преподаватели отслеживают прогресс, назначают задания и настраивают учебные планы.',
    'proj5.tag':   '3D / Unity',
    'proj5.title': 'Платформа Промышленной 3D-Визуализации',
    'proj5.desc':  'Платформа цифровых двойников, которая получает BIM-данные через API и динамически строит интерактивные 3D-визуализации в реальном времени. Пользовательские HLSL-шейдеры повышают производительность рендеринга на 12%, а асинхронные C#-конвейеры сокращают время загрузки на 70%.',
    'proj6.tag':   'Брендинг',
    'proj6.title': '3D Motion Брендинговая Кампания',
    'proj6.desc':  'Динамический motion-брендинг, объединяющий процедурную генерацию миров, физику реального времени и кинематографичную 3D-анимацию. Создан, чтобы захватывать аудиторию плавным визуальным повествованием, останавливающим прокрутку.',
