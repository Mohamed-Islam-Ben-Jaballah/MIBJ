...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'hero.tagline':     'Technical Project Manager &amp; VR Software Engineer with 7 years of experience crafting 3D solutions, VR simulations, AI-powered interfaces, and interactive web experiences that captivate clients and deliver tangible results.',
  ...
  fr: {
    ...
    'hero.name':        'Mohamed Islem<br/>Ben Jaballah',
    'hero.tagline':     'Chef de Projet Technique &amp; Ingénieur VR avec 7 ans d\'expérience à créer des solutions 3D, simulations VR, interfaces IA et expériences web interactives qui captivent les clients et offrent des résultats tangibles.',
  ...
  ar: {
    ...
    'hero.tagline':     'مدير مشاريع تقنية ومهندس برمجيات VR مع 7 سنوات من الخبرة في صياغة حلول ثلاثية الأبعاد ومحاكاة VR وواجهات ذكاء اصطناعي وتجارب ويب تفاعلية تأسر العملاء وتحقق نتائج ملموسة.',
  ...
  es: {
    ...
    'hero.name':        'Mohamed Islem<br/>Ben Jaballah',
    'hero.tagline':     'Gerente de Proyectos Técnicos &amp; Ingeniero de Software VR con 7 años de experiencia creando soluciones 3D, simulaciones VR, interfaces con IA y experiencias web interactivas que cautivan clientes y generan resultados tangibles.',
  ...
  zh: {
    ...
    'hero.greeting':    '你好，我叫',
    'hero.name':        'Mohamed Islem<br/>Ben Jaballah',
    'hero.tagline':     '技术项目经理 &amp; VR软件工程师，拥有7年经验，打造3D解决方案、VR模拟、AI驱动界面和交互式网页体验，吸引客户并带来切实成果。',
  ...
  ru: {
    ...
    'hero.name':        'Mohamed Islem<br/>Ben Jaballah',
    'hero.tagline':     'Технический руководитель проектов &amp; VR-инженер с 7-летним опытом создания 3D-решений, VR-симуляций, интерфейсов на ИИ и интерактивных веб-опытов, которые захватывают клиентов и приносят ощутимые результаты.',
